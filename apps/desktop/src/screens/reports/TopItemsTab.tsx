...
export default function TopItemsTab() {
  ...
  const fetch_ = useCallback(async () => {
    ...
    try {
      ...
      console.log('[TopItemsTab] data:', json)
      setData(json)
    } catch {
          ...
          {data.top_items.length === 0 ? (
            ...
            <>
              <div className="chart-box" style={{ background: '#fff', borderRadius: 8, padding: '1rem' }}>
                <div className="chart-title" style={{ color: '#111827' }}>{t('reports.topItems')} — {t('reports.revenue')}</div>
                <ResponsiveContainer width="100%" height={260}>
                  ...
                  >
                    ...
                    <XAxis type="number" tickFormatter={v => `R$${v}`} tick={{ fill: '#374151', fontSize: 11 }} />
                    <YAxis type="category" dataKey="name" width={130} tick={{ fill: '#374151', fontSize: 11 }} />
                    <Tooltip
